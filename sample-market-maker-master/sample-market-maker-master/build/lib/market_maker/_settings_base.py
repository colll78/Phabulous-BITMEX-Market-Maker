...
API_KEY = "exNVCVPa_hDetpwHDR4paEE9"
API_SECRET = "BqUPgajs4RMRNUyjlkMfDKu38ckK0LRPrbwp1Clb70Ong9Q9"
...
WATCHED_FILES = [join('market_maker', 'market_make.py'), join('market_maker', 'bitmex.py'), join("market_maker", "settings.py")]
